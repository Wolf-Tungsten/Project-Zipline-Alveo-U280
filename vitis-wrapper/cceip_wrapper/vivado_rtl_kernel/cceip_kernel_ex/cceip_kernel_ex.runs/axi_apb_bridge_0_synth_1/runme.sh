...
HD_PWD='/nvme0n1/gaoruihao/zipline/Project-Zipline-FPGA/vitis-wrapper/cceip_wrapper/vivado_rtl_kernel/cceip_kernel_ex/cceip_kernel_ex.runs/axi_apb_bridge_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_apb_bridge_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_apb_bridge_0.tcl
