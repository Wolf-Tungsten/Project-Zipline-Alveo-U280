...
set C_modelName {cceip_kernel}
set C_modelType { void 0 }
set C_modelArgList {
	{ m00_axi int 32 regular {axi_master 2}  }
	{ input_size int 64 unused {axi_slave 0}  }
	{ input_addr int 64 regular {axi_slave 0}  }
	{ output_size_addr int 64 unused {axi_slave 0}  }
	{ output_addr int 64 unused {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m00_axi", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input_addr","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "input_addr","bundle": "control"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 0,"step" : 1}]},{"cName": "output_size_addr","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "output_size_addr","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]},{"cName": "output_addr","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "output_addr","bundle": "control"},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "input_size", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "input_size","cData": "long int","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "input_addr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "output_size_addr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "output_addr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"cceip_kernel","role":"start","value":"0","valid_bit":"0"},{"name":"cceip_kernel","role":"continue","value":"0","valid_bit":"4"},{"name":"cceip_kernel","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_size","role":"data","value":"16"},{"name":"input_addr","role":"data","value":"28"},{"name":"output_size_addr","role":"data","value":"40"},{"name":"output_addr","role":"data","value":"52"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"cceip_kernel","role":"start","value":"0","valid_bit":"0"},{"name":"cceip_kernel","role":"done","value":"0","valid_bit":"1"},{"name":"cceip_kernel","role":"idle","value":"0","valid_bit":"2"},{"name":"cceip_kernel","role":"ready","value":"0","valid_bit":"3"},{"name":"cceip_kernel","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "input_addr", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_size_addr", "Type" : "None", "Direction" : "I"},
			{"Name" : "output_addr", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cceip_kernel_control_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cceip_kernel_m00_axi_m_axi_U", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	cceip_kernel {
		...
		input_size {Type I LastRead -1 FirstWrite -1}
		input_addr {Type I LastRead 0 FirstWrite -1}
		output_size_addr {Type I LastRead -1 FirstWrite -1}
		output_addr {Type I LastRead -1 FirstWrite -1}}}
