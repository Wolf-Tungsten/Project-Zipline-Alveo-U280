...
architecture behav of cceip_kernel is 
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal input_addr : STD_LOGIC_VECTOR (63 downto 0);
    signal output_size_addr : STD_LOGIC_VECTOR (63 downto 0);
    signal output_addr : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal icmp_ln55_reg_291 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln63_reg_324 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln63_reg_324_pp2_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal phi_ln55_reg_172 : STD_LOGIC_VECTOR (12 downto 0);
    signal phi_ln55_reg_172_pp0_iter1_reg : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_state9_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_0_reg_184 : STD_LOGIC_VECTOR (12 downto 0);
    signal phi_ln63_reg_195 : STD_LOGIC_VECTOR (12 downto 0);
    signal m00_axi_addr_reg_284 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln55_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln55_reg_291_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln55_fu_232_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln55_reg_295 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal m00_axi_addr_read_reg_300 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln58_fu_243_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln58_reg_305 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_fu_249_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_enable_reg_pp1_iter0 : STD_LOGIC := '0';
    signal zext_ln59_fu_255_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln59_reg_314 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln63_fu_273_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_enable_reg_pp2_iter0 : STD_LOGIC := '0';
    signal m00_axi_output_buffer_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal m00_axi_output_buffer_load_reg_338 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_phi_mux_phi_ln55_phi_fu_176_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln55_fu_238_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp1_stage0 : BOOLEAN;
    signal zext_ln63_fu_279_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal empty_fu_216_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp2_stage0_01001 : BOOLEAN;
    signal input_addr1_fu_206_p4 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    component cceip_kernel_m00_axi_input_buffer IS
    generic (
        DataWidth : INTEGER;
    ...
    component cceip_kernel_control_s_axi IS
    generic (
    ...
    component cceip_kernel_m00_axi_m_axi IS
    generic (
...
begin
    cceip_kernel_control_s_axi_U : component cceip_kernel_control_s_axi
    generic map (
    ...
    cceip_kernel_m00_axi_m_axi_U : component cceip_kernel_m00_axi_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    m00_axi_input_buffer_U : component cceip_kernel_m00_axi_input_buffer
    generic map (
        DataWidth => 32,
        AddressRange => 8192,
        AddressWidth => 13)
    ...
    m00_axi_output_buffer_U : component cceip_kernel_m00_axi_input_buffer
    generic map (
        DataWidth => 32,
        AddressRange => 8192,
        AddressWidth => 13)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln58_fu_243_p2 = ap_const_lv1_0))) then 
                i_0_reg_184 <= i_fu_249_p2;
            end if; 
        end if;
    end process;

    phi_ln55_reg_172_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln55_reg_291 = ap_const_lv1_0))) then 
    ...
    phi_ln63_reg_195_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state15) and (m00_axi_AWREADY = ap_const_logic_1))) then 
                phi_ln63_reg_195 <= ap_const_lv13_0;
            elsif (((ap_const_boolean_0 = ap_block_pp2_stage0_11001) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp2_stage0) and (icmp_ln63_fu_267_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln55_reg_291 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    m00_axi_addr_reg_284(61 downto 0) <= empty_fu_216_p1(61 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp2_stage0_11001) and (ap_enable_reg_pp2_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp2_stage0) and (icmp_ln63_reg_324 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln58_fu_243_p2 = ap_const_lv1_0))) then
                    zext_ln59_reg_314(12 downto 0) <= zext_ln59_fu_255_p1(12 downto 0);
            end if;
        end if;
    end process;
    m00_axi_addr_reg_284(63 downto 62) <= "00";
    zext_ln59_reg_314(63 downto 13) <= "000000000000000000000000000000000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_CS_fsm_state15, ap_enable_reg_pp2_iter2, ap_CS_fsm_state23, m00_axi_AWREADY, m00_axi_ARREADY, m00_axi_BVALID, icmp_ln55_fu_226_p2, ap_enable_reg_pp0_iter0, icmp_ln58_fu_243_p2, ap_enable_reg_pp1_iter0, icmp_ln63_fu_267_p2, ap_enable_reg_pp2_iter0, ap_enable_reg_pp2_iter1, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2, ap_block_pp1_stage0_subdone, ap_block_pp2_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln55_fu_226_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (icmp_ln58_fu_243_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (icmp_ln58_fu_243_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_pp2_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter1 = ap_const_logic_0) and (icmp_ln63_fu_267_p2 = ap_const_lv1_1) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1))) and not(((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter1 = ap_const_logic_0) and (ap_enable_reg_pp2_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp2_stage0;
                elsif ((((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter1 = ap_const_logic_0) and (icmp_ln63_fu_267_p2 = ap_const_lv1_1) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter1 = ap_const_logic_0) and (ap_enable_reg_pp2_iter2 = ap_const_logic_1)))) then
    ...
    add_ln55_fu_232_p2 <= std_logic_vector(unsigned(ap_phi_mux_phi_ln55_phi_fu_176_p4) + unsigned(ap_const_lv13_1));
    add_ln63_fu_273_p2 <= std_logic_vector(unsigned(phi_ln63_reg_195) + unsigned(ap_const_lv13_1));
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln55_reg_291, m00_axi_RVALID)
    begin
                ap_block_pp0_stage0_11001 <= ((m00_axi_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln55_reg_291 = ap_const_lv1_0));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln55_reg_291, m00_axi_RVALID)
    begin
                ap_block_pp0_stage0_subdone <= ((m00_axi_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln55_reg_291 = ap_const_lv1_0));
    end process;
    ...
    ap_block_state10_pp0_stage0_iter1_assign_proc : process(icmp_ln55_reg_291, m00_axi_RVALID)
    begin
                ap_block_state10_pp0_stage0_iter1 <= ((m00_axi_RVALID = ap_const_logic_0) and (icmp_ln55_reg_291 = ap_const_lv1_0));
    end process;
    ...
    ap_block_state18_io_assign_proc : process(icmp_ln63_reg_324_pp2_iter1_reg, m00_axi_WREADY)
    begin
                ap_block_state18_io <= ((m00_axi_WREADY = ap_const_logic_0) and (icmp_ln63_reg_324_pp2_iter1_reg = ap_const_lv1_0));
    end process;

        ap_block_state18_pp2_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state9_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state9_assign_proc : process(icmp_ln55_fu_226_p2)
    begin
        if ((icmp_ln55_fu_226_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp1_exit_iter0_state13_assign_proc : process(icmp_ln58_fu_243_p2)
    begin
        if ((icmp_ln58_fu_243_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp2_exit_iter0_state16_assign_proc : process(icmp_ln63_fu_267_p2)
    begin
        if ((icmp_ln63_fu_267_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_phi_ln55_phi_fu_176_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln55_reg_291, phi_ln55_reg_172, add_ln55_reg_295)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln55_reg_291 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    empty_fu_216_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(input_addr1_fu_206_p4),64));
    i_fu_249_p2 <= std_logic_vector(unsigned(i_0_reg_184) + unsigned(ap_const_lv13_1));
    icmp_ln55_fu_226_p2 <= "1" when (ap_phi_mux_phi_ln55_phi_fu_176_p4 = ap_const_lv13_1000) else "0";
    icmp_ln58_fu_243_p2 <= "1" when (i_0_reg_184 = ap_const_lv13_1000) else "0";
    icmp_ln63_fu_267_p2 <= "1" when (phi_ln63_reg_195 = ap_const_lv13_1000) else "0";
    input_addr1_fu_206_p4 <= input_addr(63 downto 2);
    ...
    m00_axi_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln55_reg_291, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln55_reg_291 = ap_const_lv1_0))) then 
    ...
    m00_axi_WVALID_assign_proc : process(ap_enable_reg_pp2_iter2, icmp_ln63_reg_324_pp2_iter1_reg, ap_block_pp2_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp2_stage0_11001) and (ap_enable_reg_pp2_iter2 = ap_const_logic_1) and (icmp_ln63_reg_324_pp2_iter1_reg = ap_const_lv1_0))) then 
    ...
    m00_axi_blk_n_R_assign_proc : process(m_axi_m00_axi_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln55_reg_291)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln55_reg_291 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    m00_axi_blk_n_W_assign_proc : process(m_axi_m00_axi_WREADY, ap_enable_reg_pp2_iter2, ap_block_pp2_stage0, icmp_ln63_reg_324_pp2_iter1_reg)
    begin
        if (((ap_enable_reg_pp2_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp2_stage0) and (icmp_ln63_reg_324_pp2_iter1_reg = ap_const_lv1_0))) then 
    ...
    m00_axi_input_buffer_address0_assign_proc : process(ap_block_pp0_stage0, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, zext_ln59_fu_255_p1, ap_enable_reg_pp0_iter2, zext_ln55_fu_238_p1, ap_block_pp1_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            m00_axi_input_buffer_address0 <= zext_ln59_fu_255_p1(13 - 1 downto 0);
        elsif (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            m00_axi_input_buffer_address0 <= zext_ln55_fu_238_p1(13 - 1 downto 0);
        else 
    ...
    m00_axi_input_buffer_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln55_reg_291_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln55_reg_291_pp0_iter1_reg = ap_const_lv1_0))) then 
    ...
    m00_axi_output_buffer_address0_assign_proc : process(ap_block_pp2_stage0, ap_CS_fsm_pp1_stage0, zext_ln59_reg_314, ap_CS_fsm_pp2_stage0, ap_enable_reg_pp2_iter0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, zext_ln63_fu_279_p1)
    begin
        if (((ap_enable_reg_pp2_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp2_stage0) and (ap_const_boolean_0 = ap_block_pp2_stage0))) then 
            m00_axi_output_buffer_address0 <= zext_ln63_fu_279_p1(13 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
            m00_axi_output_buffer_address0 <= zext_ln59_reg_314(13 - 1 downto 0);
        else 
    ...
    m00_axi_output_buffer_we0_assign_proc : process(icmp_ln58_reg_305, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0_11001, ap_enable_reg_pp1_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln58_reg_305 = ap_const_lv1_0))) then 
    ...
    zext_ln55_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(phi_ln55_reg_172_pp0_iter1_reg),64));
    zext_ln59_fu_255_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_184),64));
    zext_ln63_fu_279_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(phi_ln63_reg_195),64));
end behav;
